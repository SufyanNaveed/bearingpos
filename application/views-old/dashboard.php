            ...
            <div class="card-content">
                <div class="media align-items-stretch">
                    ...
                    <div class="p-1 bg-gradient-x-warning white media-body">
                        ...
                        <h5 class="text-bold-400 mb-0"><i class="ft-arrow-up"></i><?= amountExchange($todaysales, 0, $this->aauth->get_user()->loc) ?> </h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-content">
                <div class="media align-items-stretch">
                    ...
                    <div class="p-1 bg-gradient-x-success white media-body">
                        ...
                        <h5 class="text-bold-400 mb-0"><i class="ft-arrow-up"></i> <?= amountExchange($monthsales, 0, $this->aauth->get_user()->loc) ?></h5>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="heading-elements">
                    <p><span class="float-right"> <a
                                ...
                                <a
                                        ...
                                        class="btn btn-blue btn-sm rounded"><?php echo $this->lang->line('POS') ?></a></span></p>
                </div>
            </div>
            <div class="card-content">

                <div class="table-responsive">
                    <table id="recent-orders" class="table table-striped table-bordered base-style">
                        <thead>
                            <tr>
...
<div class="row match-height">
 ...
 <h4 ><?php echo $this->lang->line('cashflow') ?></h4>
    ...
    <div class="card">
        ...
        <div class="card-content">
                <div id="daily-activity" class="table table-striped table-bordered base-style">
                        ...
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                ...
                                foreach ($stock as $item) {
                                    echo '<li class="list-group-item"><span class="badge badge-danger float-xs-right">' . +$item['qty'] . ' ' . $item['unit'] . '</span> <a href="' . base_url() . 'products/edit?id=' . $item['pid'] . '">' . $item['product_name'] . '</a>
                                </li>';
                                } ?>
