                            ...
                            <ul class="nav nav-tabs">
                                <li class="nav-item">
                                    <a class="nav-link active show" id="active-tab" data-toggle="tab" href="#active"
                                       ...
                                       aria-expanded="true"> <i class="fa fa-th-list"></i> <?php echo $this->lang->line('Summary') ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="link-tab" data-toggle="tab" href="#link"
                                       aria-controls="link"
                                       aria-expanded="false"><i class="fa fa-tasks"></i> <?php echo $this->lang->line('Tasks') ?></a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" id="thread-tab" data-toggle="tab" href="#thread"
                                       aria-controls="thread"><i class="fa fa-clipboard"></i> <?php echo $this->lang->line('Thread') ?></a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" id="milestones-tab" data-toggle="tab" href="#milestones"
                                       aria-controls="milestones"><i class="fa fa-bullseye"></i> <?php echo $this->lang->line('Milestones') ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="thread-tab" data-toggle="tab" href="#activities"
                                       aria-controls="activities"><i class="fa fa-random"></i> <?php echo $this->lang->line('Activities Log') ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="linkOpt-tab" data-toggle="tab" href="#files"
                                       aria-controls="files"><i class="fa fa-folder-open"></i> <?php echo $this->lang->line('Files') ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="linkOpt-tab" data-toggle="tab" href="#notes"
                                       aria-controls="notes"><i class="fa fa-clipboard"></i> <?php echo $this->lang->line('Notes') ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="invoices-tab" data-toggle="tab" href="#invoices"
                                       aria-controls="invoices"><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('Invoices') ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="comments-tab" data-toggle="tab" href="#comments"
                                       aria-controls="comments"><i class="fa fa-comment-o"></i> <?php echo $this->lang->line('Comments') ?></a>
                                </li>
                            </ul>
