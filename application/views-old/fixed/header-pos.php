...
<head>
    ...
    <script src="<?php echo base_url('assets/myjs/mousetrap.min.js') . APPVER; ?>"></script>
...
<head>
    ...
    <script src="<?php echo base_url('assets/portjs/jquery.validate.min.js') . APPVER; ?>"></script>
    <script src="<?php echo base_url('assets/portjs/jquery.payment.min.js') . APPVER; ?>"></script>

    <script src="<?php echo base_url('assets/js/mousetrap.min.js') . APPVER; ?>"></script>
