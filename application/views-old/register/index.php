<div class="content-body">
    <div class="card">
        ...
        <div class="card-content">
            ...
            <table id="reg_table" class="table table-striped table-bordered zero-configuration" cellspacing="0" width="100%">
                <thead>
                <tr>
                    <th>#</th>
    ...
    <div class="modal-dialog">
        <div class="modal-content ">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?php echo $this->lang->line('Register') ?></h4> <button type="button" class="close" data-dismiss="modal">
