...
<div class="invoice-box"> <!--style="background-image:url(userfiles/company/bg.jpeg); no-repeat">-->
    ...
    <td>
        ...
        <td class="myw">
            <table style="width:95%" class="">
                ...
                <tr class="item mfill">
                <td style="width:50px;font-size:20px;border:none; background:none"> &nbsp; </td>
                    <td style="width:200px;font-size:20px"> &nbsp; <b><?= $general['title'] . ' No '?></b></td>
                    <td style="width:200px;font-size:20px"> &nbsp; <?= $invoice['tid']?></td>
                ...
                <tr class="item mfill">
                <td style="width:50px;font-size:20px;border:none; background:none"> &nbsp; </td>
                    <td style="font-size:20px"><b> &nbsp; <?= 'Customer Mobile' ?> </b></td>
                    <td style="font-size:20px"> &nbsp; <?php echo $invoice['phone'] ?></td>
                    <td style="font-size:20px"><b> &nbsp; <?= 'Customer Email' ?> </b></td>
                    <td style="width:350px;font-size:20px"> &nbsp; <?php echo $invoice['email'] ?></td>
                    <td style="width:80px;font-size:20px;border:none; background:none"> &nbsp; </td>
                </tr>
            </table>
        </td>
    ...
    <tr class="heading">
        ...
        <?php if ($invoice['tax'] > 0) echo '<td style="font-size:18px">' . $this->lang->line('Tax') . '</td>';
        if ($invoice['discount'] > 0) echo '<td style="font-size:18px">' . $this->lang->line('Discount') . '</td>'; ?>
        <td class="t_center" style="font-size:18px">
        ...
        foreach ($products as $row) {
            ...
            echo '<tr class="item' . $flag . '"> 
                            <td style="line-height: 0.9em;font-size:14px;">' . $row['product'] . ' </td>
