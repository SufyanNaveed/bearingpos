...
<div class="invoice-box">
    ...
    <tr class="item mfill">
                    <td style="width:300px"> &nbsp; <h1><?= $general['title'] . ' No: '?></h1></td>
                    <td style="width:500px"> &nbsp; <h2><?= $invoice['tid']?></h2></td>
                    <td style="width:300px"> &nbsp; <h1><?= ' Tax No: ' ?></h1></td>
                    <td style="width:500px"> &nbsp; <h2>123456</h2></td>
                </tr>
                <tr class="item mfill">
                    <td style="width:200px"> &nbsp; <h1><?= $general['title'] . ' ' . $this->lang->line('Date') ?> : </h1></td>
                    <td style="width:200px"> &nbsp; <h2><?php echo dateformat($invoice['invoicedate']) ?></h2></td>
                    <td style="width:200px"> &nbsp; <h1><?= 'Customer Name' ?>: </h1></td>
                    <td style="width:200px"> &nbsp; <h2><?= $invoice['name'] ?></h2></td>
                </tr>
<tr>
<td>
&nbsp;
    ...
    <br>
    <br>
    <tr class="heading" style="font-size:30px !important">
