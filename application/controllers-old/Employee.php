...
class Employee extends CI_Controller
{
    ...
    public function submit_user()
    {
        ...
        if ((string)$this->aauth->get_user($a)->id != $this->aauth->get_user()->id) {
            ...
            if ($nuid > 0) {
                ...
                $this->employee->add_employee($nuid, (string)$this->aauth->get_user($a)->username, $name, $roleid, $phone, $address, $city, $region, $country, $postbox, $location);
    ...
    public function invoices_list()
    {
        ...
        foreach ($list as $invoices) {
            ...
            $row[] = $out;
            $row[] = '<a href="' . base_url("invoices/view?id=$invoices->id") . '" class="btn btn-success btn-xs"><i class="fa fa-eye"></i> View</a> &nbsp; <a href="' . base_url("invoices/printinvoice?id=$invoices->tid") . '&d=1" class="btn btn-info btn-xs"  title="Download"><span class="fa-download"></span></a>';
    ...
    public function update()
    {
        ...
        if ($this->input->post()) {
            ...
            $this->employee->update_employee($eid, $name, $phone, $phonealt, $address, $city, $region, $country, $postbox, $location, $salary, $department);
