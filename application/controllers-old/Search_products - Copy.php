    ...
    public function pos_search()
    {
        ...
        foreach ($result as $row) {
            ...
            $out .= '    <div class="col-3 border mb-1 "><div class="rounded">
                                 <a   id="posp' . $i . '"  class="select_pos_item btn btn-outline-light-blue round" data-fprice="' . $row['fproduct_price'] . '" data-location="' . $row['product_location'] . '" data-name="' . $row['product_name'] . '"  data-price=" ' . amountExchange_s($row['product_price'], 0, $this->aauth->get_user()->loc) . '"  data-tax="' . $row['taxrate'] . '"  data-discount="' . $row['disrate'] . '"   data-pcode="' . $row['product_code'] . '"   data-pid="' . $row['pid'] . '"  data-stock="' . $row['qty'] . '" data-unit="' . $row['unit'] . '" >
                                        <img class="round"
