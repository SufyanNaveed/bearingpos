<div class="content-body">
   ...
   <div id="mybutton" class="mb-1">
                    ...
                    <hr>
                    <h4><?php echo $this->lang->line('Transactions') ?></h4>         <hr>
                    <table id="crtstable" class="table table-striped table-bordered zero-configuration" cellspacing="0" width="100%">
                        <thead>
                        <tr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?php echo $this->lang->line('Delete Transaction') ?></h4><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
