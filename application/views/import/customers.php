    ...
    <div class="card card-block">
        ...
        <div class="card card-block">
            ...
            <p>Your customer data file should as per this template <a
                        ...
                        Template</strong></a>. Please download a database backup before importing the geopos_products.
            </p>
     ...
     22. (number) Balance
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="radio" name="c_password" value="random" class="checkbox" checked="checked"/> Random
                    <br>
                    <input type="radio" name="c_password" class="mt-1" value="fixed"/> As per below field<br>
                    <input value="123456" class="form-control mt-1" type="text" name="c_password_static">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <input type="submit" class="btn btn-success margin-bottom"
                           value="<?php echo $this->lang->line('Import Customers') ?>" data-loading-text="Adding...">
