                                    ...
                                    <div class="options">
                                        <a href="<?php echo base_url('employee/invoices?id=' . $eid) ?>"
                                           class="btn btn-primary btn-block"><i
                                                    class="icon-eye"></i> <?php echo $this->lang->line('Invoices') ?> <?php echo $this->lang->line('View') ?></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                    ...
                                    <div class="options">
                                        <a href="<?php echo base_url('employee/transactions?id=' . $eid) ?>"
                                           class="btn btn-purple btn-block"><i
                                                    class="icon-eye"></i> <?php echo $this->lang->line('Transactions') ?> <?php echo $this->lang->line('View') ?></a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="options">
                                        <a href="<?php echo base_url('quote?eid=' . $eid) ?>"
                                           class="btn btn-pink btn-block"><i
                                                    class="icon-eye"></i> <?php echo $this->lang->line('Quotes') ?> <?php echo $this->lang->line('View') ?></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                    ...
                                    <div class="options">
                                        <a href="<?php echo base_url('projects?eid=' . $eid) ?>"
                                           class="btn btn-success btn-block"><i
                                                    class="icon-eye"></i> <?php echo $this->lang->line('Projects') ?> <?php echo $this->lang->line('View') ?></a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="hero-widget well well-sm">
                                    ...
                                    <div class="options">
                                        <a href="#pop_model" data-toggle="modal" data-remote="false"
                                           class="btn btn-purple btn-block"><i
                                                    class="icon-eye"></i> <?php echo $this->lang->line('Sales') ?> <?php echo $this->lang->line('View') ?></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                    ...
                                    <div class="options">
                                        <a href="#pop_model2" data-toggle="modal" data-remote="false"
                                           class="btn btn-blue btn-block"><i
                                                    class="icon-eye"></i> <?php echo $this->lang->line('Total Income') ?> <?php echo $this->lang->line('View') ?></a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="options">
                                        <a href="<?php echo base_url('employee/update?id=' . $eid) ?>"
                                           class="btn btn-info btn-block"><i
                                                    class="fa fa-user"></i> <?php echo $this->lang->line('Edit') ?> <?php echo $this->lang->line('Account') ?></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
