                    ...
                    <table id="pos_list" class="table-responsive tfr pos_stripe">
                        ...
                        <tr class="item_header bg-gradient-directional-purple white">
                            ...
                            <th width="20%"
                                ...
                                <th width="20%"
                                class="text-center">Purchase Price</th>
                            <th width="10%" class="text-center">Whole Sale Price</th>
            ...
            <form method="post" id="product_action" class="form-horizontal">
                ...
                <div class="modal-header bg-gradient-directional-info white">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><i
                                class="icon-user-plus"></i> <?php echo $this->lang->line('Add Customer') ?></h4><button type="button" class="close" data-dismiss="modal">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <button class="btn btn-success btn-lg btn-block mb-1"
                                       ...
                                       =         class="fa fa-arrow-circle-o-right"></i> <?php echo $this->lang->line('Paynow') ?> + <?php echo $this->lang->line('Print') ?>
                                    </button>
