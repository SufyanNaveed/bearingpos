                    ...
                    <div id="customerpanel" class="inner-cmp-pnl">
                        <div class="form-group row">
                            <div class="fcol-sm-12">
                                <h3 class="title">
                                    Bill To <a href='#' class="btn btn-primary btn-sm rounded" data-toggle="modal"
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6"><label for="invocieno" class="caption">Quote Number</label>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Quote #" name="invocieno"
                                ...
                                <div class="col-sm-6"><label for="invociedate" class="caption">Quote Date</label>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control required editdate"
                                               ...
                                               value="<?php echo $invoice['invoicedate'] ?>"> <input type="hidden"
                                                                                                     name="iid"
                                                                                                     value="<?php echo $invoice['iid']; ?>">
                                    </div>
                                </div>
                                <div class="col-sm-6"><label for="invocieduedate" class="caption">Quote Validity</label>
                ...
                <div id="saman-row">
                    <table class="table-responsive tfr my_stripe">
                        ...
                        <tr class="item_header bg-gradient-directional-blue white">
                            ...
                            <th width="10%" class="text-center">Amount(<?php echo $this->config->item('currency'); ?>)
                            </th>
        ...
        <div class="modal-content">
            <form method="post" id="product_action" class="form-horizontal">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Add Customer</h4>   <button type="button" class="close" data-dismiss="modal">
