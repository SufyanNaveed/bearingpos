        ...
        <div class="card-content">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-1" style="padding-left: 0px; color: white; text-align: right; ">
                        <a class="btn btn-success btn-sm pdf-link-export" href="<?php echo base_url('products/product_list_pdf') ?>">PDF Download</a>
                    </div>
                </div>
                <hr>
            ...
            <table id="productstable" class="table table-striped table-bordered zero-configuration" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <th><?php echo $this->lang->line('Product Size') ?></th>
                    <th><?php echo $this->lang->line('Country') ?></th>
                    <th><?php echo $this->lang->line('Product Location') ?></th>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content ">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?php echo $this->lang->line('View') ?></h4><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
            </div>
