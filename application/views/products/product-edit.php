    ...
    <div class="card">
        ...
        <form method="post" id="data_form" class="form-horizontal">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <select name="product_country" class="form-control">
                            <?php
                            echo '<option value="' . $country_ware['id'] . '">' . $country_ware['country_name'] . ' (S)</option>';
                ...
                <div class="form-group row">
                    ...
                    <label class="col-sm-2 col-form-label"
                           for="product_name"><?php echo $this->lang->line('Product Size') ?>*</label>

                    <div class="col-sm-6">
                        <input type="text" placeholder="Product Size"
                               class="form-control margin-bottom " name="product_size"
                               value="<?php echo $product['product_size'] ?>">
                    </div>
                </div>
                <div class="form-group row">

                    <label class="col-sm-2 col-form-label"
                           for="product_name"><?php echo $this->lang->line('Product Location') ?>*</label>

                    <div class="col-sm-6">
                        <input type="text" placeholder="Product Location"
                               class="form-control margin-bottom " name="product_location"
                               value="<?php echo $product['product_location'] ?>">
                    </div>
                </div>
                <div class="form-group row">
...
<script src="<?php echo base_url('assets/myjs/jquery.ui.widget.js');
