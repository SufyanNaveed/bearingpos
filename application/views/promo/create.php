        ...
        <div class="card-content">
            ...
            <div class="col-sm-6">         <fieldset>
              <div class="custom-control custom-radio">
                ...
                <label class="custom-control-label" for="customRadio1"><?php echo $this->lang->line('Yes') ?> &nbsp;</label>
              </div>
            </fieldset>
                    <fieldset>
              <div class="custom-control custom-radio">
                <input type="radio" class="custom-control-input" name="link_ac" id="customRadio2" value="no">
                <label class="custom-control-label" for="customRadio2"><?php echo $this->lang->line('No') ?></label>
              </div>
            </fieldset>
</div>
                </div>
