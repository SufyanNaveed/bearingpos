Job Description
We are looking for an enthusiastic and creative graphic designer to join our team.

Must have worked in professional environment
Can think outside of the box and come up with new ideas
Have animation experience
Social media graphics
website and mobile app designs and mocks
UX Experience will be highly preferred<?php
/**
...
// Your Account SID and Auth Token from twilio.com/console
    ...
    public function printinvoice()
    {
        ...
        if (INVV == 2) {
            $pdf = $this->pdf->load_split(array('margin_top' => 65));
        }
